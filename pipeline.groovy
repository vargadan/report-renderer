...
// 		sh "export MAVEN_OPTS='${mvnCmd} org.jacoco:jacoco-maven-plugin:report sonar:sonar -Dsonar.host.url=http://sonarqube:9000/ -DskipTests=true"
 		sh "export MAVEN_OPTS='${mvnCmd} sonar:sonar -Dsonar.host.url=http://sonarqube:9000/ -DskipTests=true"
   	}
